...
export function DemoAddExpenseForm({
  budgetId,
  categories,
  budgets,
}: {
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
        ...
        {budgets.length > 0 && (
          <DemoCsvImportTrigger categories={categories} budgets={budgets} />
        )}
      </div>
    </form>
  );
