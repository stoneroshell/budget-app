      ...
      {open && (
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div>
              <label htmlFor="month" className="mb-1 block text-xs font-medium uppercase tracking-widest text-charcoal-400">
                Month
              </label>
              <select
                id="month"
            ...
            <div>
              <label htmlFor="year" className="mb-1 block text-xs font-medium uppercase tracking-widest text-charcoal-400">
                Year
              </label>
              <select
                id="year"
            ...
            <div>
              <label htmlFor="income" className="mb-1 block text-xs font-medium uppercase tracking-widest text-charcoal-400">
                Monthly income ($)
              </label>
              <input
                id="income"
